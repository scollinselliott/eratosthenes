...
* absolute constraints, as either _termini post_ or _ante quem_, expressed as samples from a probability density
...
In order to estimate a date of use for any one artifact, one can use the `gibbs_ad()` function again, taking the production date of the artifact type from the `marginals` object as a _t.p.q._ and its depositional context as a _t.a.q._.
