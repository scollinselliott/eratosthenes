...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/eratosthenes)](https://CRAN.R-project.org/package=eratosthenes)
...
Multiple sequences can, and typically will, be given. To define seven more sequences for this tutorial, we have additional deposits from the site of Carthage (Byrsa Hill) and also several shipwrecks (see the `eda20250628.rmd` file in the `inst/` directory for more information):
