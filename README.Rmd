...
A `sequences` object contains all of the information about the relative relationships of the contexts, in terms of which come before or after one another, which should be based on a stated rationale (typically, sequences from a seriation, stratigraphic sequences, or even hypotheses).
