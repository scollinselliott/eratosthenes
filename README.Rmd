...
It is recommended though that one use their preferred calibration software (see the example using `Bchron` in the [Tutorial: Archaeological Example](#tutorial-arhaeological-example) above).
...
* `sequences` : A `seqeunces` object, containing relative sequences of contexts or events.
...
* `tpq` and `taq` :  Format must follow that illustrated in the Section above on [Absolute Constraints](#absolute-constraints). 
